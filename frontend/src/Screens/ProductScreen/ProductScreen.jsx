              ...
              <div className="col-md-6 col-sm-12 description-container p-5">
                <div className="main-description">
                  ...
                  <div className="add-inputs">
                    ...
                    <button name="add_to_cart" type="submit" className="btn btn-dark btn-lg product-btn" onClick={() => { handleAddToCart(product) }}>Add to cart</button>
                  </div>
                  <div className="add-inputs">
                    {
                        ...
                        <>
                          {
                            (wishlist.wishlist.some((obj) => obj._id === product._id)) ?
                              <button name="add_to_cart" type="submit" className="btn btn-outline-dark btn-lg product-btn product-btn-wish" onClick={() => dispatch(removeItem(product))}>Remove from Wishlist</button>
                              : <button name="add_to_cart" type="submit" className="btn btn-outline-dark btn-lg product-btn product-btn-wish" onClick={() => dispatch(addProduct(product))}>Add to Wishlist</button>
